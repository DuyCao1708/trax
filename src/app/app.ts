...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, Categories, IonHeader, IonToolbar, IonTitle],
  template: `
    <ion-header>
      <ion-toolbar>
        <ion-title>
          <a class="inline-block max-h-10 ps-4">
            <svg height="24" viewBox="0 0 792 193" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
