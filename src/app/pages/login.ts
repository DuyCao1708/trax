...
@Component({
    ...
    <ion-content>
      <div class="w-full h-full flex flex-col justify-around login-bg">
        ...
        <div class="flex flex-col items-center gap-4 mx-8">
          ...
          <ion-button expand="block" class="w-full">
  ...
  styles: `
    .login-bg {
      background:
        linear-gradient(212deg, transparent 0%, var(--ion-background-color) 40%),
        url('/outline-background.png') no-repeat top center / cover;
    }
  `,
})
export class Login {}
